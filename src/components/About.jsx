...
export const About = () => {
    ...
    <>
      ...
      <section className="About mt-20">
        <div className="text-left py-5 px-10 font-bold text-lg">
          ...
          <br />
          <p>
            My proficiency includes web technologies like HTML, CSS,
            JavaScript, Node.js, React.js, Express.js, PostgreSQL, and MongoDB.
          </p>
          <br />
          <p>
            I have hands-on experience with blockchain technologies, such as
            Ethereum, Bitcoin Blockchain, Smart Contracts, Truffle, Hardhat,
            and Ganache.
          </p>
          <br />
          <p>
  ...
  <div className="px-5 flex flex-wrap gap-5 justify-center">
    <div className={`sm:w-[150px] flex flex-col items-center ${commonStyles}`}>
      <img className="py-5 w-1/2" src="/images/javascript-original.svg" alt="JSimg" />
      JavaScript
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/html5-original.svg" alt="HTMLimg" />
      HTML5
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/css3-original.svg" alt="CSSimg" />
      CSS3
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/python-original.svg" alt="PyImg" />
      Python
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2 bg-gray-400" src="/images/solidity-original.svg" alt="SolImg" />
      Solidity
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    ...
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/postgresql-original.svg" alt="reactImg" />
      PostgreSQL
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/nodejs-original.svg" alt="nodeImg" />
      Node
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2 bg-gray-600" src="/images/express-original.svg" alt="nodeImg" />
      Express
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/postman-original.svg" alt="postmanImg" />
      Postman
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/git-original.svg" alt="gitImg" />
      Git
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/github-original.svg" alt="reactImg" />
      GitHub
    </div>
    <div className={`sm:w-[150px] flex flex-col items-center justify-center ${commonStyles}`}>
    <img className="py-5 w-1/2" src="/images/react-original.svg" alt="reactImg" />
